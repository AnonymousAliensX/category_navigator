...
class _NavigationMenuState extends State<NavigationMenu> {
  ...
  /// of all the widgets, it updates the [NavigatorController] for [NavigationMenu.defaultActiveItem].
  /// Even though the item is being set as active, it will be not be visible to
  /// the user if [NavigationMenu.defaultActiveItem] is set to a larger index. For that, [WidgetsBinding.addPostFrameCallback]
  ...
  /// list has to scroll to get to the active item. Later, it uses the [NavigationMenu.scrollController]
  /// and scrolls the list to the item at [NavigationMenu.defaultActiveItem] using
  ...
  /// direction. If [NavigationMenu.expand] is true, this method is called
